...
Subfolders are included. The page lists the folder through nginx (autoindex, see call-backend/deploy/nginx-menkerud.conf).
Without nginx, add an index.json here with the file names: ["ferie1.jpg", "tur/bursdag.png"]
A network share works too: mount it at /mnt/bilder on the screen PC and set Bildemappe to /bilder/ (SETUP.md section 3).
